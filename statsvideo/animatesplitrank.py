...
class ThreeD(ThreeDScene):
    ...
    def construct(self):
        data_file = os.path.join("statsvideo", "data", "splitrank.csv")
...
if __name__ == "__main__":
    os.system(r"manim -qk -v WARNING -p --disable_caching -o ThreeD.mp4 .\statsvideo\animatesplitrank.py ThreeD")