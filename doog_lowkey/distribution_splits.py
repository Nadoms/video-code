...
class Plot(Scene):
    ...
    def construct(self):
        ...
        # Get player and season from environment variables
        ...
        # Title
        title = Text(f"{player.capitalize()} - {split}", font_size=24)
...
if __name__ == "__main__":
    ...
    for p in ["doogile", "Lowk3y_"]:
        for s in ["fortress", "stronghold", "end"]:
            os.system(rf"PLAYER={p} SPLIT={s} manim -qp -o {p}{s} {name}.py {name.capitalize()}")
